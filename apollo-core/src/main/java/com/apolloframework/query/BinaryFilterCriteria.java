...
public class BinaryFilterCriteria extends BaseFilterCriteria {
     ...
     */
    public BinaryFilterCriteria(String joinName, String fieldName, FilterOperation operation, Object value) {
